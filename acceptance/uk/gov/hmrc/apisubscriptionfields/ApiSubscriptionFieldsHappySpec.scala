...
class ApiSubscriptionFieldsHappySpec extends AcceptanceTestSpec
  ...
  feature("Subscription-Fields") {
    ...
    scenario("the API is called to store some values for a new subscription field") {
      ...
      sfr.get shouldBe SubscriptionFieldsResponse(FakeClientId, "acontext", "1.0.2", fieldsId, SampleFields1)
    }
    ...
    scenario("the API is called to GET all existing subscription fields") {
      ...
      sfr.isSuccess shouldBe true
      sfr.get shouldBe BulkSubscriptionFieldsResponse(Seq(SubscriptionFieldsResponse(FakeClientId, "acontext", "1.0.2", fieldsId, SampleFields1)))
    }
    ...
    scenario("the API is called to GET with a known fieldsId") {
      ...
      sfrFieldsId.get shouldBe SubscriptionFieldsResponse(FakeClientId, "acontext", "1.0.2", fieldsId, SampleFields1)
    }
    ...
    scenario("the API is called to update existing subscription fields") {
      ...
      sfr.isSuccess shouldBe true
      sfr.get shouldBe SubscriptionFieldsResponse(FakeClientId, "acontext", "1.0.2", fieldsId, SampleFields2)
    }
