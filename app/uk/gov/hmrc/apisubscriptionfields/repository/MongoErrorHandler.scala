...
//
//  def handleDeleteError(result: DeleteResult, exceptionMsg: => String): Boolean = {
...
//  }
//
//  private def handleError(result: DeleteResult, f: DeleteResult => Boolean, exceptionMsg: String): Boolean = {
