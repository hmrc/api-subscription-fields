...
import uk.gov.hmrc.apisubscriptionfields.model.{ApiContext, ApiVersion, AppId, SubscriptionIdentifier}
import util.TestData

class ModelSpec extends WordSpec with Matchers with TestData{
